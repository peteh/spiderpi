...
def portInit():  # configurate uses IO port
    GPIO.setup(rx_pin, GPIO.OUT)  # configurate RX_CON that is GPIO17 as output
    GPIO.output(rx_pin, 0)
    GPIO.setup(tx_pin, GPIO.OUT)  # configurate TX_CON that is GPIO17 as output
...
def portRead():  # configurate single-wire serial is output
    GPIO.output(rx_pin, 1)  # pull up TX_CON that is GPIO27
    GPIO.output(tx_pin, 0)  # pull down RX_CON that is GPIO17
