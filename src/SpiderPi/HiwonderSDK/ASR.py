...
class ASR:
    ...
    #2：2：password mode, with the first entry as the password. The status light is always off, when the password is recognized, it is always on, waiting for a new voice to be recognized, and the recognition result will be off after reading the recognition result
